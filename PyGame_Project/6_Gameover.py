...
#화면 타이틀 설정
pygame.display.set_caption("풍선 게임") # 게임 이름
...
image_path = os.path.join(current_path, "images") # images 위치 폴더 반환
...
while running:
    ...
    # 경과 시간 계산
    elpsed_time = (pygame.time.get_ticks() - start_ticks) / 1000
    timer = game_font.render("Time : {}".format(int(total_time - elpsed_time)), True, (255, 255, 255))
    screen.blit(timer, (10, 10))

    # 시간 초과
    if total_time - elpsed_time <= 0:
