...
#화면 타이틀 설정
pygame.display.set_caption("허명철의 게임") # 게임 이름

# FPS
clock = pygame.time.Clock()

# 배경 이미지 불러오기
background = pygame.image.load("D:\\파이썬\\PyGame\\PyGame_Basic\\Background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("D:\\파이썬\\PyGame\\PyGame_Basic\\Character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("D:\\파이썬\\PyGame\\PyGame_Basic\\Enemy.png")
